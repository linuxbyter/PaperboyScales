    ...
    <div className="min-h-screen">
      <nav className="border-b border-border px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a href="/admin/agents" className="text-sm text-muted hover:text-ink transition-colors">
            Agents
          </a>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="card p-6">
            <p className="text-sm text-muted uppercase tracking-wider">Commission Owed</p>
            <p className="text-3xl font-bold mt-2 text-brass tabular-nums" style={{ fontFamily: "var(--font-mono)" }}>
              ${Number(stats.commission_owed).toFixed(2)}
            </p>
          </div>
          <div className="card p-6">
            <p className="text-sm text-muted uppercase tracking-wider">In Flight</p>
            <p className="text-3xl font-bold mt-2 text-warn tabular-nums" style={{ fontFamily: "var(--font-mono)" }}>
              {Number(stats.in_flight)}
            </p>
          </div>
          <div className="card p-6">
            <p className="text-sm text-muted uppercase tracking-wider">Total Volume</p>
            <p className="text-3xl font-bold mt-2 text-ink tabular-nums" style={{ fontFamily: "var(--font-mono)" }}>
